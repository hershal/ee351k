    ...
    \begin{solution} \hfill\\\vspace{1.5em}
      ...
      \begin{figure}[hbt]
        ...
        \begin{subfigure}[b]{0.45\textwidth}
          \resizebox{\textwidth}{!}{\input{3-1}}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
          \resizebox{\textwidth}{!}{\input{3-2}}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
          \resizebox{\textwidth}{!}{\input{3-3}}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
          \resizebox{\textwidth}{!}{\input{3-4}}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
          \resizebox{\textwidth}{!}{\input{3-5}}
        \end{subfigure}
        \begin{subfigure}[b]{0.45\textwidth}
          \resizebox{\textwidth}{!}{\input{3-6}}
        \end{subfigure}
