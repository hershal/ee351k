      ...
      \item $P(2 \le Y \le 1)$ can be obtained through normalization
        \begin{equation}
          ...
          \begin{aligned}
            ...
            &= P\left(Z\le \frac{1-1}{2}\right) - P\left(Z\le \frac{-2-1}{2}\right) \\
      ...
      \item $P(|Y|^2 < 1.5)$ is captured the same as the above,
        ...
        \begin{equation}
          ...
          \begin{aligned}
            ...
            &= P(-1.2247 \le Y \le 1.2247) \\
            &= -1 + 2P\left(Z\le \frac{y_0-\mu_y}{\sigma_y}\right)\\
            &= -1 + 2P\left(Z\le \frac{1.2247-1}{2}\right) \\
            &= -1 + 2P\left(Z\le \frac{1.2247-1}{2}\right) \\
            &= -1 + 2P(Z\le 0.1123) \\
            P(|Y|^2 \le 1.5) &= -1 + 2(0.5447) \\
            \implies P(|Y|^2 \le 1.5)  &= 0.0894 \\
          \end{aligned}
        \end{equation}
      \end{enumerate}
    \end{solution}
    ...
    \begin{solution} \hfill
      \begin{equation}
        \begin{aligned}
          ...
          \int_{0}^{\infty} P(X > x) \dd{x} &=
          \int_0^\infty \int_x^\infty f_X(t) \dd{t} \dd{x} \\
          &= \int_0^\infty \int_0^t f_X(t) \dd{x}\dd{t} \\
          &= \int_0^\infty t f_X(t) \dd{t} \\
          \implies \int_0^\infty P(X>x)&= E[X] \\
        \end{aligned}
      \end{equation}
    \end{solution}
  \end{Ex}
